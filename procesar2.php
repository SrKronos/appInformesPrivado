...
function obtenerReporteEmergencia($desde, $hasta) {
    ...
    $query = "select * from public.vatencionespacientes v inner join public.vdiagnosticospacientes v1 
    on
    v.id_paciente = v1.id_paciente and v.id_secuencial = v1.id_secuencial
    ...
    if ($stmt->execute()) {
        ...
        header('Content-Disposition: attachment;filename="reporte_consulta_externa.xlsx"');
